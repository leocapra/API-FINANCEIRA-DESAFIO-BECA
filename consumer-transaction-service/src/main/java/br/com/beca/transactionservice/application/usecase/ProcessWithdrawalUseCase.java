...
public record ProcessWithdrawalUseCase(TransactionRepository repository, BankAccountPort bankRepository, CurrencyConverterPort converter, TransactionEventPublisher publisher) {
