...
class UserRepositoryImplTest {
    ...
    void saveUser_shouldSetIdFromCpfIfExists_thenSaveAndReturnMappedDomain() {
        ...
        existingByCpf.setId(UUID.fromString("11111111-1111-1111-1111-11111111111"));

        User domainOut = new User(UUID.fromString("11111111-1111-1111-1111-11111111111"), domainIn.getCpf(), domainIn.getNome(), domainIn.getEmail(), domainIn.getSenha(), domainIn.getTelefone());
        ...
        assertEquals(UUID.fromString("11111111-1111-1111-1111-11111111111"), captor.getValue().getId());
    ...
    void saveUser_shouldSetIdFromEmailIfExists_thenSaveAndReturnMappedDomain() {
        ...
        existingByEmail.setId(UUID.fromString("11111111-1111-1111-1111-11111111111"));
    ...
    void updateUser_shouldUpdateProfileAndSave_whenUserExists() {
        User domainIn = new User(
                UUID.fromString("11111111-1111-1111-1111-11111111111"),
                "123.456.789-09",
                "Nome Novo",
                "novo@email.com",
                "senhaHash",
        ...
        existingJpa.setId(UUID.fromString("11111111-1111-1111-1111-11111111111"));

        UserJpa savedJpa = existingJpa; // simulando retorno do save
        User domainOut = domainIn;

        when(repository.findById(UUID.fromString("11111111-1111-1111-1111-11111111111"))).thenReturn(Optional.of(existingJpa));
        ...
        verify(repository).findById(UUID.fromString("11111111-1111-1111-1111-11111111111"));
